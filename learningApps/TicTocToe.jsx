...
const GameHomeScreen = () => {
  ...
  const startGame = () => {
    // You can implement the logic to start the game here
    console.log(`Starting game between ${player1} and ${player2}`);
  };

  // Function to render each game record
  ...
  return (
    <View style={gameHomeStyles.container}>
      ...
      <View style={gameHomeStyles.playerInputContainer}>
        ...
        />
        {/* Start Game Button */}
        <TouchableOpacity style={gameHomeStyles.button} onPress={startGame}>
...
export {GameStartScreen, GameBoard};
